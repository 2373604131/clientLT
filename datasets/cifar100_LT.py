...
class Cifar100_LT():
    ...
    def __init__(self, cfg):
        ...
        data_train, data_test, lab2cname, classnames, net_dataidx_map_train, net_dataidx_map_test, traindata_cls_counts, testdata_cls_counts, y_train = partition_data_LT(
            'cifar100_LT', self.dataset_dir, cfg.DATASET.PARTITION, cfg.DATASET.USERS,
            beta=cfg.DATASET.BETA, logdir="./logs/",
            imb_factor=cfg.DATASET.IMB_FACTOR, imb_type=cfg.DATASET.IMB_TYPE,
