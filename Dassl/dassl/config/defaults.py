...
# Client-longtail partition defaults
_C.DATASET.HEAD_CLIENT_RATIO = 0.9
_C.DATASET.TAIL_CLIENT_RATIO = 0.1
_C.DATASET.HEAD_CLASS_RATIO = 0.8
_C.DATASET.TAIL_CLASS_RATIO = 0.2
_C.DATASET.SPECIALIZATION_LAMBDA = 1.0
_C.DATASET.INTRA_GROUP_ALPHA = 0.1
_C.DATASET.HEAD_LEAKAGE_SCALE = 0.0
_C.DATASET.LOGIT_ADJUST = False
_C.DATASET.LOGIT_ADJUST_TAU = 1.0
...
# Setting for the test_acpfl data-loader
...
_C.TEST.NO_TEST = True
# Use test_acpfl or val set for FINAL evaluation
_C.TEST.SPLIT = "test_acpfl"
# Which model to test_acpfl after training (last_step or best_val)
# If best_val, evaluation is done every epoch (if val data
# is unavailable, test_acpfl data will be used)
